...
\xmuchapter{系统设计}{SystemDesign}
\xmusection{概要设计}{System Design Principles}
\xmusection{详细设计}{Overall Architecture Design}
正文内容。

\xmusubsection{核心模块设计}{Core Module Design}
zheng
